...
CREATE TABLE IF NOT EXISTS events_json(key binary, offset bigint, partition int, timestamp bigint, topic string, value binary) USING json location '${DA.paths.kafka_events}';
